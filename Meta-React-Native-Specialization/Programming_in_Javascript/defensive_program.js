...
assign to it a check that makes sure that the type of match is a string 
...
As a passing test, run the letterFinder funciton and pass it with correct arguments, such as: 
letterFinder("cat", "c").
...
function letterFinder(word, match) {
    ...
    if (condition1 && condition2){
        ...
        console.log("Please pass correct argurments to the function.")
    }
