...
// Add the try and catch blocks inside the function definition's body. For now, just make sure that the console log of a + b is 
// inside the try block. Additionally, the catch block should catch an error named err and, inside the body of the catch block, 
// you need to console log the err value.
function addTwoNums(a, b){
    try{
    console.log(a + b);
    } catch(err){
